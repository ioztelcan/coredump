...
git filter-branch --env-filter  'if \[ $GIT\_COMMIT = 119f9ecf58069b265ab22f1f97d2b648faf932e0 \] then export GIT\_AUTHOR\_DATE="Fri Jan 2 21:38:53 2009 -0800" export GIT\_COMMITTER\_DATE="Sat May 19 01:01:01 2007 -0700" fi'
...
## To delete the branch "branch\_name"
...
This can be used to diff files that are not in a git repo! git diff --no-index path/to/file/A path/to/file/B
...
\(helps save data when cloning large repos\) git clone --depth 1 
...
So, this will show the first commit that has "cool" in their message body git show :/cool
...
you will see a list of every thing you've done in git, across all branches! each one has an index HEAD@{index} find the one before you broke everything then:
